...
<!-- header -->
		<header>
			<div class="wrapper">
				<h1><a href="index.php" id="logo">Travels</a></h1>
				<div class="right">
					<div class="wrapper">
				&nbsp;
					</div>
			...
			<nav>
				...
				<!--	<li><a href="Destinations.html" class="nav2">Destinations</a></li>  -->
					...
					<li style="float:right"><a class="activep" href="register.php">Register</a></li>
				</ul>			
				</nav>
			<div class="text">
...
<!-- content -->
		...
		<article class="col2 pad_left1">
				<form id="ContactForm" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="f2">
					<div>
				<div class="wrapper">Name:<input type="text" class="input" name="name" placeholder="name" required ><br></div>
...
<!-- <div class="wrapper">Address:<textarea  cols="1" rows="1" name="add" placeholder="address" required></textarea></div> -->
<div class="wrapper">Pin code :<input type="text" class="input" name="pin" placeholder="pin code" required ><br></div>
						<div class="wrapper">Mobile no:<input type="text" class="input" name="mo" placeholder="Mobile No" required ><br></div>
						<div class="wrapper">E-mail:<input type="text" class="input" name="email" placeholder="Email" required ><br></div>

						<div class="wrapper">Password:<input type="password" class="input" name="pass" placeholder="Password" required ><br></div>
...
//	$address = $_POST['add'];
	...
	if($name =='' || $gender =='' || $dob =='' || $mobile =='' || $pin_code =='' || $email =='' || $password =='' || $date =='' ){
	?>
    <script>
